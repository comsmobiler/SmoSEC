    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SMOSEC.Infrastructure.SMOSECDbContext>
    {
        ...
        protected override void Seed(SMOSEC.Infrastructure.SMOSECDbContext context)
        {
            ...
            context.coreUsers.AddOrUpdate(
                new coreUser { USER_ID = "13123456789", USER_ADDRESS = "嘉兴", USER_BIRTHDAY = DateTime.Now, USER_NAME = "富贵", USER_ROLE = "ADMIN", USER_PASSWORD = "123456", USER_LOCATIONID = "01" },
                ...
                new coreUser { USER_ID = "12345678917", USER_ADDRESS = "嘉兴", USER_BIRTHDAY = DateTime.Now, USER_NAME = "李狗蛋", USER_ROLE = "SMOSECUser", USER_PASSWORD = "123456", USER_LOCATIONID = "01", USER_ISDEMO = 1 }
                );
